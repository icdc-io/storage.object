...
const errorNotification = (msg) =>
	cogoToast.error(
		notificationMessages[localStorage.getItem("icdc-lang") || "en"].error + msg,
		notificationOptions,
	);
const successNotification = (msg) =>
	cogoToast.success(
		notificationMessages[localStorage.getItem("icdc-lang") || "en"].success +
			msg,
		notificationOptions,
	);
...
export const fetchBuckets = (username) => ({
	...
	payload: fetchData(
		`${ActionTypes.bucketsUrl()}?filter[user_name]=${username}`,
	),
});
